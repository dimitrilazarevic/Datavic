...
npx sv@0.16.1 create --template minimal --types ts --add prettier eslint sveltekit-adapter="adapter:static" drizzle="database:sqlite+sqlite:better-sqlite3" storybook --install npm ./
```
