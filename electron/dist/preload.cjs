...
electron.contextBridge.exposeInMainWorld("electronAPI", {
	...
	getEntityImage: (entity, folderName, ext) => electron.ipcRenderer.invoke("get-entity-image", entity, folderName, ext),
	...
	db: {
		...
		bottle: {
			...
			uploadAnalysis: (id, data) => electron.ipcRenderer.invoke("db:bottle:uploadAnalysis", id, data),
		...
		material: {
			...
			uploadAnalysis: (id, data) => electron.ipcRenderer.invoke("db:material:uploadAnalysis", id, data),
			deleteAnalysis: (id, key) => electron.ipcRenderer.invoke("db:material:deleteAnalysis", id, key)
		}
	}
});
//#endregion
